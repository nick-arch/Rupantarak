...
gdrive_url = 'https://drive.google.com/file/d/12mv1VM69G6kZH14kmMflvmm9XZpJ2CJP/view?usp=drivesdk'
...
def display_success():
    ...
    <div id="success-popup" class="success-popup">
        ...
        <h3>ʀᴜɴ ʙᴇʟᴏᴡ ᴄᴇʟʟs ᴛᴏ ᴜsᴇ रूपांतरक ~ Ꮢᥙραɳ𝜏αɾαƙ ᑌᑎᑕᗴᑎᔕᗝᖇᗴᗪ</h3>
        <div class="arrow"></div>
    </div>
    """
