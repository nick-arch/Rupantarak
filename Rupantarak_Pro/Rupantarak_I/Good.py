...
<div style="width: 350px; height: 40px; text-align: center; margin: 10px auto; display: flex; justify-content: center; align-items: center; background-color: #000000; border-radius: 20px;">
  <span style="color: white; font-size: 18px; background-image: linear-gradient(90deg, #FF007F, #800080); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold;">Run à¤°à¥‚à¤ªà¤¾à¤‚à¤¤à¤°à¤• ~ Rupantarak Uncensored</span>
</div>
...
def display_popup_message(message, background_color='#000000', border_color='#333333', text_color_start='#FF007F', text_color_end='#800080'):
    popup_html = f"""
    <style>
        .popup-message {{
            position: fixed;
    ...
    <div class="popup-message">
        <h2><span class="bypass">à¤°à¥‚à¤ªà¤¾à¤‚à¤¤à¤°à¤• ~ Bypass</span><br><span class="unlocked">Unlocked Successfully</span></h2>
    </div>
    <script>
        setTimeout(function(){{
            var popup = document.querySelector('.popup-message');
...
display(container)
display(output)
display_popup_message("à¤°à¥‚à¤ªà¤¾à¤‚à¤¤à¤°à¤• ~ Bypass Unlocked Successfully")
